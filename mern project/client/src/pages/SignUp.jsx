...
export default function SignUp() {
  ...
  return (
    <div className='h-screen flex justify-center items-center' style={{ backgroundImage: "url('https://u.realgeeks.media/maxrealusa/_rgg/landscape_images/RowHouses.jpg')", height: '90vh', backgroundSize: 'cover', backgroundPosition: 'center' }}>
