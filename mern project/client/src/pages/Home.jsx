    ...
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      >
        ...
        >
          ...
          <h3 className="text-xl sm:text-3xl mt-4 font-bold text-black">
          ...
          <Link
            to={'/search'}
            className="text-sm sm:text-lg mt-4 text-blue-950 font-bold hover:underline px-4 py-2 rounded"
          >
            Let's get started...
          </Link>
        </motion.div>
      ...
      <div class="flex flex-row bg-white rounded-lg py-10">
        <div class="text-container bg-white w-5/6 sm:w-3/5 mx-auto py-10 pl-0 sm:pl-16">
          <h2 class="text-2xl sm:text-4xl font-bold mb-10 text-blue-900">
            Imagine your dream home...
          </h2>
          <p class="text-sm sm:text-lg mb-8 leading-loose text-slate-400">
          ...
          <ul class="list-none p-0 mb-8 pl-6">
            <li class="flex items-center space-x-4">
              <span class="text-slate-500 text-sm sm:text-lg font-bold leading-loose">Stop endless searching! Find your haven in minutes.</span>
            </li>
            <li class="flex items-center space-x-4">
              <span class="text-slate-500 text-sm sm:text-lg font-bold leading-loose">Fall in love with beautiful listings curated for you.</span>
            </li>
            <li class="flex items-center space-x-4">
              <span class="text-slate-500 text-sm sm:text-lg font-bold leading-loose">Turn the key and unlock a new chapter filled with joy.</span>
            </li>
          </ul>
          <p class="text-sm sm:text-lg font-bold text-slate-400">
            Let's make your dream home a  <span className='text-blue-900'> R E A L I T Y!</span>
          </p>
        </div>
        <div className='hidden sm:inline pb-16'>
